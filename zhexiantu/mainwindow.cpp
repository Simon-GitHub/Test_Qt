...
void MainWindow::Paint()
{
    ...
    painter.drawText(pointx+kx*maxpos-kx,pointy-a[maxpos]*ky-5,QString::fromLocal8Bit("最大值")+QString::number(_ma));
    painter.drawText(pointx+kx*minpos-kx,pointy-a[minpos]*ky+15,QString::fromLocal8Bit("最小值")+QString::number(_mi));
